...
class ChildRuleTest extends Facebook\HackTest\HackTest {
  public function testNoChild(): void {
    ...
    foreach ($elems as $elem) {
      expect($elem->__toString())->toBeEqual('<div></div>');
    }
  }
  ...
  public function testSingleChild(): void {
    ...
    foreach ($elems as $elem) {
      ...
      expect($elem->toString())->toBeEqual('<div></div>');
    }
  }
  ...
  public function testToString(
    ...
    expect($elem->__getChildrenDeclaration())->toBeEqual($expected);
  }
  ...
  public function testPCDataChild(): void {
    ...
    expect($x->toString())->toBeEqual('<div>herp derp</div>');
    $x = <test:pcdata-child>{123}</test:pcdata-child>;
    expect($x->toString())->toBeEqual('<div>123</div>');
  }
  ...
  public function testFrags(): void {
    ...
    expect($x->toString())->toBeEqual('<div>foobar</div>');
  }
